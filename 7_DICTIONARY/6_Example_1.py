...
Nhập môn Trí tuệ nhân tạo – Lập trình Python
    ...
    b. Sau vài ngày, bạn nhận được những món đồ nội thất mới: 9 tấm thảm, mỗi tấm trị giá
150 đô la và 4 chiếc đèn, mỗi chiếc trị giá 180 đô la. Vì vậy, bạn thêm chúng vào từ điển (sử dụng các cú pháp khác nhau).
...
del store["furniture"].find('table')
print(store)